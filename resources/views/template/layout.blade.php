  ...
  <div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	  ...
	  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home.index') }}">
		...
		<div class="sidebar-brand-text mx-3">Fort Pro</div>
	  </a>
	  ...
	  <li class="nav-item">
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
		  <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#">Receitas</a>
            <a class="collapse-item" href="#">Contas a Pagar</a>
            <a class="collapse-item" href="#">Empréstimo</a>
            <a class="collapse-item" href="#">Transferência</a>
			<a class="collapse-item" href="#">Entrada/Saída Manual</a>
		  </div>
		</div>
	  </li>
