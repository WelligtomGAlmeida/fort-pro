...
class CreateLoansTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('loans', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('debt_account_id')->nullable($value = false);
            ...
            $table->decimal('debt_value', 15, 2)->nullable($value = false);
            $table->integer('credit_installment')->nullable($value = false);
            $table->integer('debt_installment')->nullable($value = false);
            $table->date('credit_date')->nullable($value = false);
            $table->date('debt_date')->nullable($value = false);
            $table->timestamps();
            ...
            $table->foreign('debt_account_id')->references('id')->on('accounts');
